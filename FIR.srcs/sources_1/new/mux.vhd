...
type temp_arr is array (natural range <>) of std_logic_vector(2*input_data_width-1 downto 0);
signal mux_in : temp_arr(n_param downto 0);
...
data_out <= mux_in(to_integer(unsigned(sel)));
